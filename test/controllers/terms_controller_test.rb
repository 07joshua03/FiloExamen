...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { definition: @term.definition, end_term: @term.end_term, name: @term.name, other_et: @term.other_et } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { definition: @term.definition, end_term: @term.end_term, name: @term.name, other_et: @term.other_et } }
